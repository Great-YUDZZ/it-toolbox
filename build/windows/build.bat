...
if not exist "rsrc_windows_amd64.syso" (
    ...
    go run github.com/tc-hib/go-winres@latest simply --icon assets/icon.png --manifest gui --product-version 1.3.0 --file-version 1.3.0 --product-name "IT Toolbox" --file-description "IT Toolbox - All-in-one Toolkit for IT Students & Developers" --copyright "Copyright © 2026 Great-YUDZZ" --original-filename "it-toolbox.exe"
)
